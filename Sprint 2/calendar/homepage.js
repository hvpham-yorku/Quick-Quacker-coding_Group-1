document.addEventListener('DOMContentLoaded', function () {
    ...
    // Modify the existing checkButton event listener in the addTask function
    // Replace the existing check button event listener with this one:
    const addOriginalTask = addTask;
    
    // Override the addTask function to add our streak functionality
    addTask = function() {
        const taskText = todoInput.value.trim();
        if (taskText === '') return;
    ...
    // Modify the addTask function to use our new saveTask function
    // Replace the existing addTask function with this updated version
    function addTask() {
        const taskText = todoInput.value.trim();
        if (taskText === '') return;
